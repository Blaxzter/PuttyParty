...
export const en: Dictionary = {
  ...
  gameForm: {
    ...
    strokeLimit: 'Stroke limit per hole',
    maxStrokes: 'Max. strokes',
    penalty: 'Penalty',
    recordedMax: 'At most {n} strokes per hole are recorded.',
  ...
  validation: {
    ...
    maxPerHoleN: (n: number) => `At most ${n} strokes per hole.`,
    strokeLimitRange: 'Limit: 1–90 strokes per hole.',
    penaltyRange: 'Penalty: 0–9.',
